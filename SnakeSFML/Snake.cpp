...
void Snake::randMove()
{
	srand(time(NULL));
	int num = rand() % 5;
	if (num == 1 && direction_!= Direction::Down && nodes_[0].getPosition().x > 1 && nodes_[0].getPosition().x < Game::Width - 1)
		direction_ = Direction::Up;
	else if (num == 2 && direction_ != Direction::Up && nodes_[0].getPosition().x > 1 && nodes_[0].getPosition().x < Game::Width - 1)
		direction_ = Direction::Down;
	else if (num == 3 && direction_ != Direction::Right && nodes_[0].getPosition().y > 1 && nodes_[0].getPosition().y < Game::Height - 1)
		direction_ = Direction::Left;
	else if (num == 4 && direction_ != Direction::Left && nodes_[0].getPosition().y > 1 && nodes_[0].getPosition().y < Game::Height - 1)
		direction_ = Direction::Right;
	move();
	checkEdgeCollisions(false);
}

void Snake::update(sf::Time delta)
{
	move();
	checkEdgeCollisions(true);
	checkSelfCollisions();
}
...
void Snake::checkEdgeCollisions(bool borders)
{
	SnakeNode& headNode = nodes_[0];
